...
class Personne extends \App\Entity\Personne implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Personne' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Personne' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Personne' . "\0" . 'questions', '' . "\0" . 'App\\Entity\\Personne' . "\0" . 'id'];
        }
     ...
     * {@inheritDoc}
     */
    public function addQuestion(\App\Entity\Question $question): void
    {
